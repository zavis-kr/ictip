...
### 1. 메인 대시보드
> 실시간 위협 KPI · 위협 피드 · 글로벌 공격 지도 · 지정학적 리스크 · 위협 행위자 TOP 10
...
### 2. 위협 관리
> 9,000+ 건 수집 피드 실시간 조회 · 심각도 · 유형 · 소스별 필터링
...
### 3. 위협 등록
> IOC 값 · TLP 등급 · MITRE ATT&CK · 행위자 정보 수동 등록

![Threat Submit](docs/screenshots/localhost_3000_submit.png)
...
![Agency Share](docs/screenshots/localhost_3000_share.png)

---

### 5. 인텔리전스 허브 — 위협 트렌드 예측
> 최근 30일 위협 추세 · 향후 7일 예측 · 위협 유형 핫스팟 · 요일별 패턴 · 행위자 활동

![Threat Trend](docs/screenshots/localhost_3000_intelligence.png)

---

### 6. 인텔리전스 허브 — IOC 관계 그래프
> 위협 행위자 · IOC · 캠페인 간 연관 관계 네트워크 시각화

![](<docs/screenshots/localhost_3000_intelligence (1).png>)

---

### 7. 인텔리전스 허브 — YARA / Sigma 룰 자동 생성
> 위협 IOC 기반 악성코드 탐지 룰 · SIEM 탐지 룰 자동 생성

![](<docs/screenshots/localhost_3000_intelligence (2).png>)

---

### 8. 인텔리전스 허브 — PDF 보고서
> 일간 위협 요약 보고서 · 위협별 상세 보고서 (IOC · MITRE · AI 분석 포함) 자동 생성
...
### 9. 인텔리전스 허브 — SIEM 연동
> Splunk HEC · Elastic · QRadar Webhook 연동 · JSON / CEF 포맷 지원

![](<docs/screenshots/localhost_3000_intelligence (4).png>)

---

### 10. 인텔리전스 허브 — 다크웹 모니터링
> OSINT 기반 다크웹 키워드 모니터링 · Have I Been Pwned 데이터 유출 탐지

![](<docs/screenshots/localhost_3000_intelligence (5).png>)
